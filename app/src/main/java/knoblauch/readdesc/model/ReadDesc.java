...
public class ReadDesc {
    ...
    /**
     * @brief - Define the possible source types for a read. A read can have various
    ...
    /**
     * @brief - The name of the read: presents a user-defined strings identifying
    ...
    /**
     * @brief - The type of the source associated to this read. Depending on the
    ...
    /**
     * @brief - The source of the read. Presents a string identifying the read
    ...
    /**
     * @brief - The creation date of this read. Expressed using the default date
    ...
    /**
     * @brief - A date representing the last time the user accessed this read to
    ...
    /**
     * @brief - An indication of how far the user has progressed through this read.
    ...
    /**
     * @brief - Creates a new read with the specified name and source. The creation
     ...
     */
    public ReadDesc(String name, Type type, String source) {
    ...
    /**
     * @brief - Retrieves the name associated to this read.
    ...
    /**
     * @brief - Return the type of the source associated to this read. The type can be
    ...
    /**
     * @brief - The source of the read as a string. Refers to the external resource
    ...
    /**
     * @brief - Retrieves the creation date of this read as a `Date` object.
    ...
    /**
     * @brief - Returns the last access date for this read. Should usually be more
    ...
    /**
     * @brief - Returns the completion percentage of this read. Represents how far
    ...
    /**
     * @brief - Used to determine whether the user has finished this read or not. It
